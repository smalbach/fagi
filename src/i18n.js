...
const DICT = {
  en: {
    ...
    'brainmap.feel.found': 'led to food',
    'brainmap.feel.energy': 'energy',
    'brainmap.feel.lost': 'led nowhere',
    ...
    'brainmap.rule.swimOut': 'in deep water: out by the nearest shore',
    'brainmap.rule.shelter': 'raining: take shelter in the nest',
    ...
    'type.toxico': 'Toxic',
    'type.agua': 'Water',
    'type.feromona': 'Own trail',
    'type.hondo': 'Deep water',
    'type.charco': 'Puddle',
    'type.nido': 'Nest',
    'type.arbol': 'Tree',
    'type.roca': 'Rock',
    ...
    'hint.puddle': 'shallow, dries up in the sun',
    ...
    'action.swimOut': 'Struggling out of the water',
    'action.shelter': 'Taking shelter from the rain',
    ...
    'reason.swimOut': 'deep water: no footing, heads for the nearest shore',
    'reason.shelter': 'it is raining: to the nest until it stops',
    'reason.shelterIn': 'waits out the rain inside the nest',
    ...
    'log.probe': 'Feels water with its antennae',
    'log.probeSub': 'humidity and wet touch before stepping in: it slows and probes',
    'log.rain': 'It starts to rain',
    'log.rainSub': 'washes away the pheromone trail and leaves puddles',
    'log.rainStop': 'The rain stops',
    'log.rainStopSub': 'puddles will dry up in the sun',
    'log.puddleGone': 'The puddle has dried up',
    'log.puddleGoneSub': 'not where it remembered it: it must look for water again',
    'log.dunkSub': '{secs}s paddling · learns {arrow} {before} → {after}',
    ...
    'sense.found': 'led to food',
    'sense.energy': 'energy {v}',
    'sense.lost': 'led nowhere',
  ...
  es: {
    ...
    'brainmap.feel.found': 'llevó a comida',
    'brainmap.feel.energy': 'energía',
    'brainmap.feel.lost': 'no llevó a nada',
    ...
    'brainmap.rule.swimOut': 'en el hondo: salir por la orilla más cercana',
    'brainmap.rule.shelter': 'llueve: refugiarse en el nido',
    ...
    'type.toxico': 'Tóxico',
    'type.agua': 'Agua',
    'type.feromona': 'Feromona propia',
    'type.hondo': 'Agua honda',
    'type.charco': 'Charco',
    'type.nido': 'Nido',
    'type.arbol': 'Árbol',
    'type.roca': 'Roca',
    ...
    'hint.puddle': 'poco hondo, se seca al sol',
    ...
    'action.swimOut': 'Sale pataleando del agua',
    'action.shelter': 'Se refugia de la lluvia',

    'tag.explore': 'EXPLORA',
    'tag.seekFood': 'CAZA',
    'tag.seekWater': 'SED',
    'tag.drink': 'BEBE',
    'tag.swimOut': 'SE HUNDE',
    'tag.swim': 'SE HUNDE',
    'tag.rain': 'LLUVIA',
    'tag.shelter': 'REFUGIO',
    'tag.track': 'OLOR',
    ...
    'reason.swimOut': 'agua honda: no hace pie, va a la orilla más cercana',
    'reason.shelter': 'llueve: al nido hasta que escampe',
    'reason.shelterIn': 'espera dentro del nido a que escampe',
    ...
    'log.probe': 'Nota el agua con las antenas',
    'log.probeSub': 'humedad y tacto mojado antes de pisarla: frena y tantea',
    'log.rain': 'Empieza a llover',
    'log.rainSub': 'borra el rastro de feromona y deja charcos',
    'log.rainStop': 'Deja de llover',
    'log.rainStopSub': 'los charcos se irán secando al sol',
    'log.puddleGone': 'El charco se ha secado',
    'log.puddleGoneSub': 'no está donde lo recordaba: tiene que buscar agua otra vez',
    'log.dunkSub': '{secs}s pataleando · aprende {arrow} {before} → {after}',
    ...
    'sense.found': 'llevó a comida',
    'sense.energy': 'energía {v}',
    'sense.lost': 'no llevó a nada',
